...
const MarketPlace = () => {
  ...
  const handleAdd = async (e) => {
    ...
    try {
      console.log("test..");
      const url = "https://apismarket.herokuapp.com/api/products/insert";
  ...
  useEffect(() => {
    axios.get("https://apismarket.herokuapp.com/api/products/get").then((res) => {
      setApiList(res.data);
    });
  }, []);
  ...
  const handleUpdate = () => {
    ...
    axios.put("https://apismarket.herokuapp.com/api/products/update", {
      id: update.id,
      data: data,
    });
  ...
  const handleDelete = (id) => {
    axios.delete(`https://apismarket.herokuapp.com/api/products/delete/${id}`);
  };
  return (
    <>
